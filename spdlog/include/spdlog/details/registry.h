...
public:
    ...
    // To be used directly by the spdlog default api (_event.g. spdlog::info)
    // This make the default API faster, but cannot be used concurrently with set_default_logger().
    // _event.g do not call set_default_logger() from one thread while calling spdlog::info() from
    // another.
