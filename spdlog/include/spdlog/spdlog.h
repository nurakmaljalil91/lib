...
// example: spdlog::set_pattern("%Y-%m-%d %H:%M:%S.%_event %l : %v");
...
// _event.g: spdlog::info("Message {}", 1);
//
...
// _event.g do not call set_default_logger() from one thread while calling spdlog::info() from another.
