...
/**
 * _update the given texture rectangle with new pixel data.
 *
...
/**
 * _update a rectangle within a planar YV12 or IYUV texture with new pixel
 * data.
 *
...
/**
 * _update a rectangle within a planar NV12 or NV21 texture with new pixels.
 *
 * You can use SDL_UpdateTexture() as long as your pixel data is a contiguous
...
/**
 * Set the color used for drawing operations (Rect, Line and cleanup).
 *
...
/**
 * Get the color used for drawing operations (Rect, Line and cleanup).
 *
 * \param renderer the rendering context.
...
/**
 * cleanup the current rendering target with the drawing color.
 *
...
/**
 * _render a list of triangles, optionally using a texture and indices into the
...
/**
 * _update the screen with any rendering performed since the previous call.
 *
